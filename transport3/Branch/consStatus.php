...
<select  class="form-control"  name="bs" id="bs" required="" >
  <?php
...
<input type="submit"  value="select Branch" name="sb"  id="sb">
</form>
<table class="table">
...
$recieverAddress=$_POST['bs'];

        include 'dbcon.php';


          $home_quer="SELECT * FROM consdetails WHERE recieverAddress = '".$recieverAddress."' ";
          $home_quer_res=$con->prepare($home_quer);
          $home_quer_res->execute();

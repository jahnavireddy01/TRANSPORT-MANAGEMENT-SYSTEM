  ...
  <tbody>
    ';
        include 'dbcon.php';
          ...
          $home_query1="SELECT * FROM consstatus Where CSid='".$_POST['trackid']."' ";
          $home_result1=$con->prepare($home_query1);
          $home_result1->execute();

            try 
              {
                if ($home_result1)
                {
                  $home_quer_res_as=$home_result1->fetchAll();
